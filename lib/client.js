window.__ModuleLoader__.load({ id: "@dsh-external/dsh-headroom-suite", factory: (require) => {
  var module = { exports: {} };
...
var ROUTE_URL = "/headroom-mgr/route";
var STATUS_URL = "/headroom-mgr/status";
...
function HeadroomPanel(props) {
  ...
  (0, import_react.useEffect)(() => {
    fetch(STATUS_URL, { cache: "no-store" }).then((r) => r.json()).then((b) => {
...
var STATUS_URL2 = "/headroom-mgr/status";
var START_URL = "/headroom-mgr/start";
var STOP_URL = "/headroom-mgr/stop";
